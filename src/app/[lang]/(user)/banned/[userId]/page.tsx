        ...
        <div className="bg-gray-100 flex items-center justify-center min-h-[50vh]">
            <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
                ...
                <p className="text-gray-600 mb-6">
                    You have been banned from logging in to the site. Try again
                    after <span className="text-blue-500">{expireDateEnd}</span>
                </p>
                <p className="text-red-500 mb-6">
                    Reason: Too many failed login
                </p>
                <div className="flex flex-col gap-2">
                    <a
                        href="mailto:aansourav@gmail.com"
