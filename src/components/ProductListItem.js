    ...
    <div>
      <div className={classes.card}>
        ...
        <div className={classes['item-info']}>
          {/* <h4 className={classes['card-price']}>MRP :{` Tk. ${offer_price}`}</h4>
          <h4 className="card-discount">
          Discount : {`${props.discountPercentage}Tk`}
          </h4>
          <h4 className="card-discount">
          ...
          <table cellspacing="30" cellPadding="15" >
            ...
            <tbody>
              <tr>
                <td className={classes['card-price']}><span className={classes.strikeout}>{`Tk. ${original_price}`}</span> {`Tk. ${offer_price}`}</td>
                <td className={classes['card-discount']}>{`${props.discountPercentage}.Tk`}</td>
